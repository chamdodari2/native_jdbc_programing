///TitleDao 인터페이스를 구현하는곳. 테스트는TitleDaoTest에서
package native_jdbc_programing.dao.impl; //계속쓰기때문에 싱클턴패턴으로 구현한다.
...
import native_jdbc_programing.util.JdbcUtil;   ///TitleDao 인터페이스를 구현하는곳
...
///////
	...
	public Title selectTitleByNo(Title title) {
		...
		try(Connection con = JdbcUtil.getConnection();
				...
				pstmt.setInt(1, title.gettNo()); //1에 이걸 집어넣으라고 하는거?
